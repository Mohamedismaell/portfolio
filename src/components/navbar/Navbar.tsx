            ...
            {scrolled ? (
              ...
              >
                ...
                <button
                  ...
                  className="text-xs bg-[var(--text-primary)] hover:opacity-90 hover:shadow-md text-[var(--text-inverse)] px-3.5 py-1.5 rounded-full font-medium transition-all"
                >
                  {t("nav.letsTalk")}
                </button>
              </motion.div>
...
className="hidden md:flex text-xs bg-[var(--text-primary)] hover:opacity-90 hover:shadow-md text-[var(--text-inverse)] px-3.5 py-1.5 rounded-full font-medium transition-all items-center gap-1.5 group shadow-sm"
                  >
<span>Resume</span>
